...
import ModifyContactForm from "@/app/contacts/ModifyContactForm";
        ...
        <div className="container-fluid">
            ...
            <Row>
                ...
                <Col className="col-md-10 ps-0 pe-0">
                    <Nav variant="underline" className="bg-dark-subtle border-bottom" defaultActiveKey={`/contacts/${params.id}`}>
                        ...
                        <Nav.Item>
                            <Nav.Link eventKey={`/contacts/${params.id}`}>Modify Contact</Nav.Link>
                        </Nav.Item>
                    </Nav>
                    <br></br>
                    <div className="container-fluid ps-3 pe-3">
                        <h3>Modify Contact</h3>
                        {params.id ? (<ModifyContactForm id={params.id}/>): (<div></div>)}
